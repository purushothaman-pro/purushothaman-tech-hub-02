...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-40 right-20 w-8 h-8 bg-accent/20 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-40 left-20 w-12 h-12 border-2 border-accent/20 rotate-45 animate-float" style={{ animationDelay: '4s' }}></div>
