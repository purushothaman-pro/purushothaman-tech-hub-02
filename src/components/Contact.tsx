...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-b from-secondary/50 to-background">
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <Card key={index} className="border-0 bg-gradient-to-r from-card to-primary/5 card-hover">
            ...
            <Card className="border-0 bg-gradient-to-r from-accent/10 to-primary/10">
              <CardContent className="p-6">
                ...
                <p className="text-foreground/80 text-sm mb-4">
                  Feel free to send me a direct email for quicker communication.
                </p>
                <Button 
